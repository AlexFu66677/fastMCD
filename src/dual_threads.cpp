...
//   newX = (h[h_id * 9 + 0] * X + h[h_id * 9 + 1] * Y + h[h_id * 9 + 2]) /
//   newW; newY = (h[h_id * 9 + 3] * X + h[h_id * 9 + 4] * Y + h[h_id * 9 + 5])
//   / newW; return cv::Point2f(newX, newY);
// }
...
//     // char bufbuf[1000];
//     // sprintf(bufbuf,
//     "/home/fjl/code/fast/fastMCD-new/data/res10/frm%05d.png",
//     //         num);
//     // num++;
